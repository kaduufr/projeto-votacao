  ...
  <div class="d-flex flex-md-row flex-column">
    <div class=" flex flex-grow-1 min-vh-90 pe-4">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <p class="fw-semibold fs-2">Eleições Ativas</p>
      ...
      <ul>
        @foreach ($eleicoes as $eleicao)
          <div class="d-flex flex-column justify-content-between position-relative align-items-center box-borded">
            ...
            <div class="d-flex flex-row gap-2 pt-4 z-2">
              <a href="{{route('show_eleicao', $eleicao->id)}}" class="btn btn-success fw-bold fs-5">
                Votar
              </a>
